          ...
          while( have_rows('highlight-services') ) : the_row();
            ...
            <div class="col-sm-6 col-md-4">
              <div class="panel highlingt_detail margin-top30">
                ...
                <h4 class="text-center highlingt_title"><a href="<?php echo $url ?>"><?php echo $name ?></a></h4>
...
<section class="bg-gray section-space">
  <div class="container">
    <div class="row">
      <?php $image = get_field('diva_intro_img'); ?>
      <div class="col-md-6 vertical-align-middle service-img" style="background-image: url(<?php echo esc_url($image['url']); ?>);">
      </div>
      <div class="col-md-6 vertical-align-middle services">
        <h2>Giới thiệu viện thẩm mỹ Diva</h2>
        <p class="intro"><?php the_field('diva_intro'); ?></p>
      </div>
    </div>
  </div>
</section>
...
<div class="container section-space">
  <div class="fun-facts counter-iconic section_space relative text-center overly1 parallax">
    <div class="row section-title">
      <div class="col-md-12">
        <h2 class="text-center why-us">VÌ SAO NÊN CHỌN VIỆN THẨM MỸ DIVA?</h2>
        <p><?php the_field('why-choose-description'); ?></p>
      </div>
    </div>
    <div class="clearfix relative z-index10">
      <?php
      if( have_rows('why-choose-us') ): 
        while( have_rows('why-choose-us') ) : the_row();
          $title         =   get_sub_field('why-title');
          $description   =   get_sub_field('why-description');
          $image         =   get_sub_field('why-image');
          ?>
          <div class="col-md-3">
            <div class="counter margin-top30">
              <div class="text-center">
                <div class="icon center-block"><img src="<?php echo $image['url'] ?>" alt="<?php echo $image['alt'] ?>"></div>
              </div>
              <span class="number quantity-counter2 quantity-counter highlight facts"><?php echo $title ?></span>
              <span class="what-do"><?php echo $description ?></span>
            </div>
          </div>
        <?php endwhile;
      endif;
...
<section class="bg-gray section-space">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 vertical-align-middle service-img" style="background-image: url(<?php echo esc_url($image['url']); ?>);">
        <a class="btn_play" href="<?php the_field('video_link'); ?>" target="_blank"><i class="far fa-play-circle"></i></a>
      </div>
      <div class="col-md-6 vertical-align-middle services">
        <a href="<?php the_field('video_link'); ?>"><h3 class="video-con-title"><?php the_field('video_title'); ?></h3></a>
  ...
  <div class="row"> 
    <div class="col-md-12">
      <section class="gallery">
        <div class="row section-title">
          <div class="col-md-12"> 
            <h2 class="text-center">CHUYÊN MỤC NỔI BẬT</h2>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-12">
              <section class="faq">
                <div class="row section-title">
                  <div class="col-md-12">
                    <h2 class="text-center">VỀ DIVA</h2>
                  </div>
                </div>
                <?php
				if( have_rows('about_diva') ):
				    while( have_rows('about_diva') ) : the_row();
				        $title 			= 	get_sub_field('about_diva_title');
				        $description 	= 	get_sub_field('about_diva_décription');
				    ?>
				    <div class="single-faq margin-top30">
				    	<div class="view-full single-faq-title">
				    		<div class="single-faq-title-inner-border">
				    			<button class="tcon tcon-plus tcon-plus-check" type="button">
				    				<span class="tcon-visuallyhidden"></span>
				    			</button>
				    			<span class="question"><?php echo $title ?></span>
				    		</div>
				    	</div>
            ...
            <div class="form">
              ...
              <form class="col-md-6 center-block form-active clearfix " data-client-email-field="E-mail" data-client-name-field="Name" data-title="New email from your website" method="post">
                ...
                <div class="col-md-12 text-center">
                  <button class="button " type="button"><span>Gửi cho chúng tôi</span></button>
                </div>
              </form>
            </div>
          </div>
